...
interface NeedInitProps {
	visible: boolean
	init?: boolean
	data?: Configuration[]
}

const NeedInit = ({ visible, init, data }: NeedInitProps) => {
			...
			<CModalBody>
				...
				>
					...
					<Input labelPosition={'top'}
						   ...
						   initialValue={virtualAccessKey}
						   placeholder={'모의투자용 접근키를 입력하세요.'} />
					<Input labelPosition={'top'}
						   label={'secret key'}
						   dispatcher={setVirtualSecretKey}
						   initialValue={virtualSecretKey}
